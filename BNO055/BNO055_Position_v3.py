# BNO055 position tracking script v3.0
...
#          the BNO055 on my custom nRF52832 board. Data is exported to CSV for
#          analysis.
# Algorithm: This script is an extension of my implementation. v3 adds 
#            the boundary conditions from measurements of the cage.
...
for i in range(len(acc_world_hp)):
    ...
    for axis, key in enumerate(['x', 'y', 'z']):
        ...
        if zupt_mask[i]:
         ...
         # --- Apply cage position limits ---
        X[axis][0] = np.clip(X[axis][0], cage_limits[key][0], cage_limits[key][1])
